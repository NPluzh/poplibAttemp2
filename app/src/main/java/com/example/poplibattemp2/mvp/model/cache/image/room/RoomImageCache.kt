package com.example.poplibattemp2.mvp.model.cache.image.room
...
import com.example.poplibattemp2.mvp.model.entity.room.RoomCachedImage
...
class RoomImageCache(val db: Database, val dir: File) : IImageCache {
    ...
    override fun contains(url: String) = Single.fromCallable { db.imageDao.findByUrl(url) != null }.subscribeOn(
        Schedulers.io())
